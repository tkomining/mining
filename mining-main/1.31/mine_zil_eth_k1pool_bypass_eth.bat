...
:W10
%MyVariable% --algo ETHASH --pool !POOL! --user !K1LOGIN! --worker !WORKER! --enablezilcache --dualmode zil --dualstratum !ETHWALLET!@!ETHPOOL! --watchdog exit
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
%MyVariable% --algo ETHASH --pool !POOL! --user !K1LOGIN! --worker !WORKER! --enablezilcache --dualmode zil --dualstratum !ETHWALLET!@!ETHPOOL! --watchdog exit --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
