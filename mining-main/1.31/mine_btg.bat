...
:W10
%MyVariable% -a !ALGO! --pers !PERSONALIZATION! --pool !POOL! --user !WALLET!  --watchdog exit
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
%MyVariable% -a !ALGO! --pers !PERSONALIZATION! --pool !POOL! --user !WALLET! --watchdog exit --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
