...
:W10
%MyVariable% --algo ETHASH --pool !POOL! --user !ETHWALLET!.!WORKER! --pass !ZILWALLET!@!ETHPOOL! --dualmode zil --dualstratum !ETHWALLET!@!ETHPOOL! --enablezilcache  --watchdog exit
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
%MyVariable% --algo ETHASH --pool !POOL! --user !ETHWALLET!.!WORKER! --pass !ZILWALLET!@!ETHPOOL! --dualmode zil --dualstratum !ETHWALLET!@!ETHPOOL! --enablezilcache --watchdog exit --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
