...
:W10
%MyVariable% --algo ETHASH --pool !POOL! --user !ETHWALLET!.!ZILWALLET! --worker !WORKER! --dualmode zil --dualstratum !ETHWALLET!@!ETHPOOL! --enablezilcache   --watchdog exit
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
%MyVariable% --algo ETHASH --pool !POOL! --user !ETHWALLET!.!ZILWALLET! --worker !WORKER! --dualmode zil --dualstratum !ETHWALLET!@!ETHPOOL! --enablezilcache  --watchdog exit --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
