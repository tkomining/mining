...
:W10
%MyVariable% --algo ETCHASH  --pool !POOL! --user !WALLET! --pool !POOL2! --user !WALLET!  --watchdog exit
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
%MyVariable% --algo ETCHASH  --pool !POOL! --user !WALLET! --pool !POOL2! --user !WALLET! --watchdog exit --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
